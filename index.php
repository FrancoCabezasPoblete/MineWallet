...
<header>
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">MineWallet</a>
      ...
      <div class = "card">
        <!--<div class = "card-img-overlay">-->
          <ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
            <li class="nav-item">
              <a class="nav-link active" id="LogIn-tab" data-toggle="tab" href="#LogIn" role="tab" aria-controls="LogIn" aria-selected="true"><b>Log In</b></a>
            </li>
            <li class="nav-item">
